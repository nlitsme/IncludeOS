...
# make distclean
../newlib-$newlib_version/configure --target=$TARGET --prefix=$PREFIX --enable-newlib-io-long-long AS_FOR_TARGET=as LD_FOR_TARGET=ld AR_FOR_TARGET=ar RANLIB_FOR_TARGET=ranlib #CC_FOR_TARGET="clang -Wno-return-type --target=i686-pc-none-elf" #--target=i686-elf -ffreestanding
